...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/05/17 14:42:53 by mondrew           #+#    #+#             */
/*   Updated: 2020/05/21 14:02:37 by mondrew          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_check_mfw(const char **str, va_list *ptr, int *min_nul)
{
	int mfw;
...
void		ft_analyze_that(const char **str, va_list *ptr, size_t *counter)
{
	...
	mfw = ft_check_mfw(str, ptr, &min_nul);
